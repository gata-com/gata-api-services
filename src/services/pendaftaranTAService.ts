...
//   TAStatus,
//   SumberTopik,
// } from "../entities/pendaftaranTA";
// import { Student } from "../entities/role/student";
...
// const mahasiswaRepo = AppDataSource.getRepository(Student);
...
//     const savedPendaftaran: PendaftaranTA = await manager.save(PendaftaranTA, pendaftaran);
